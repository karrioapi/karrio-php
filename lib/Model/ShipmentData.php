...
class ShipmentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'customs' => '\Karrio\Model\CustomsData',
        'reference' => 'string',
        'label_type' => 'string',
        'service' => 'string',
        'services' => 'string[]',
     ...
     * Gets customs
     *
     * @return \Karrio\Model\CustomsData|null
     */
     ...
     * Sets customs
     *
     * @param \Karrio\Model\CustomsData|null $customs customs
     *
     * @return self
     */
    ...
    public function setReference($reference)
    {
        if (!is_null($reference) && (mb_strlen($reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling ShipmentData., must be smaller than or equal to 100.');
        }
     ...
     * Sets service
     *
     * @param string|null $service **Specify a service to Buy a label in one call without rating.**
     *
     * @return self
     */
    public function setService($service)
    {
        ...
        if (!is_null($service) && (mb_strlen($service) < 1)) {
            throw new \InvalidArgumentException('invalid length for $service when calling ShipmentData., must be bigger than or equal to 1.');
        }
     ...
     * Sets services
     *
     * @param string[]|null $services The requested carrier service for the shipment.  Please consult the reference for specific carriers services.<br/> Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier.
     *
     * @return self
     */
