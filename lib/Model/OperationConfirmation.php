 ...
 */
class OperationConfirmation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OperationConfirmation';
    ...
    public function setOperation($operation)
    {
        ...
        if ((mb_strlen($operation) < 1)) {
            throw new \InvalidArgumentException('invalid length for $operation when calling OperationConfirmation., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierName($carrier_name)
    {
        ...
        if ((mb_strlen($carrier_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_name when calling OperationConfirmation., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierId($carrier_id)
    {
        ...
        if ((mb_strlen($carrier_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_id when calling OperationConfirmation., must be bigger than or equal to 1.');
        }
