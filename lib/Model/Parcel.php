...
class Parcel implements ModelInterface, ArrayAccess
{
     ...
     * Sets packaging_type
     *
     * @param string $packaging_type The parcel's packaging type.  Note that the packaging is optional when using a package preset  For specific carriers packaging type, please consult [the reference](#operation/all_references).
     *
     * @return $this
     */
     ...
     * Sets package_preset
     *
     * @param string $package_preset The parcel's package preset.  For specific carriers package preset, please consult [the reference](#operation/all_references).
     *
     * @return $this
     */
