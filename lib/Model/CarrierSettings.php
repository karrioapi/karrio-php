...
class CarrierSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const CARRIER_NAME_DHL_POLAND = 'dhl_poland';
    ...
    const CARRIER_NAME_GENERIC = 'generic';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object_type'] = $data['object_type'] ?? 'carrier';
    }
    ...
    public function setObjectType($object_type)
    {
        ...
        if (!is_null($object_type) && (mb_strlen($object_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_type when calling CarrierSettings., must be bigger than or equal to 1.');
        }
