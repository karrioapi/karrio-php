 ...
 */
class PickupUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PickupUpdateRequest';
    ...
    public function setPickupDate($pickup_date)
    {
        ...
        if ((mb_strlen($pickup_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pickup_date when calling PickupUpdateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets address
     *
     * @param \Karrio\Model\Address $address address
     *
     * @return self
     */
     ...
     * Sets parcels
     *
     * @param \Karrio\Model\Parcel[] $parcels The shipment parcels to pickup.
     *
     * @return self
     */
    ...
    public function setConfirmationNumber($confirmation_number)
    {
        ...
        if ((mb_strlen($confirmation_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $confirmation_number when calling PickupUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setReadyTime($ready_time)
    {
        ...
        if ((mb_strlen($ready_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ready_time when calling PickupUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClosingTime($closing_time)
    {
        ...
        if ((mb_strlen($closing_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $closing_time when calling PickupUpdateRequest., must be bigger than or equal to 1.');
        }
