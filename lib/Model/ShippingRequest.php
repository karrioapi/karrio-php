...
class ShippingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setReference($reference)
    {
        if (!is_null($reference) && (mb_strlen($reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling ShippingRequest., must be smaller than or equal to 100.');
        }
     ...
     * Sets rates
     *
     * @param \Karrio\Model\Rate[] $rates The list for shipment rates fetched previously
     *
     * @return self
     */
