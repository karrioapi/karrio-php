...
class Charge implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Charge., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling Charge., must be bigger than or equal to 1.');
        }
