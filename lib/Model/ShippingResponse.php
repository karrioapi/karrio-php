 ...
 */
class ShippingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingResponse';
    ...
    protected static $openAPITypes = [
        ...
        'parcels' => '\Karrio\Model\Parcel[]',
        'services' => 'string[]',
        'options' => 'object',
        'payment' => '\Karrio\Model\Payment',
        'customs' => '\Karrio\Model\Customs',
        'rates' => '\Karrio\Model\Rate[]',
        'reference' => 'string',
        'label_type' => 'string',
        'carrier_ids' => 'string[]',
        'tracker_id' => 'string',
        ...
        'selected_rate' => '\Karrio\Model\Rate',
        'docs' => '\Karrio\Model\Documents',
        'meta' => 'object',
        'service' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object_type'] = $data['object_type'] ?? 'shipment';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ShippingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setObjectType($object_type)
    {
        ...
        if (!is_null($object_type) && (mb_strlen($object_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_type when calling ShippingResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets shipper
     *
     * @param \Karrio\Model\Address $shipper shipper
     *
     * @return self
     */
     ...
     * Sets recipient
     *
     * @param \Karrio\Model\Address $recipient recipient
     *
     * @return self
     */
     ...
     * Sets parcels
     *
     * @param \Karrio\Model\Parcel[] $parcels The shipment's parcels
     *
     * @return self
     */
     ...
     * Sets services
     *
     * @param string[]|null $services The carriers services requested for the shipment.  Please consult the reference for specific carriers services.<br/> Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier.
     *
     * @return self
     */
     ...
     * Gets customs
     *
     * @return \Karrio\Model\Customs|null
     */
     ...
     * Sets customs
     *
     * @param \Karrio\Model\Customs|null $customs customs
     *
     * @return self
     */
     ...
     * Sets rates
     *
     * @param \Karrio\Model\Rate[]|null $rates The list for shipment rates fetched previously
     *
     * @return self
     */
    ...
    public function setCreatedAt($created_at)
    {
        ...
        if ((mb_strlen($created_at) < 1)) {
            throw new \InvalidArgumentException('invalid length for $created_at when calling ShippingResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets selected_rate
     *
     * @param \Karrio\Model\Rate|null $selected_rate selected_rate
     *
     * @return self
     */
     ...
     * Gets docs
     *
     * @return \Karrio\Model\Documents|null
     */
     ...
     * Sets docs
     *
     * @param \Karrio\Model\Documents|null $docs docs
     *
     * @return self
     */
