...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'object_type' => 'string',
        'validation' => '\Karrio\Model\AddressValidation'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object_type'] = $data['object_type'] ?? 'address';
    ...
    public function setFederalTaxId($federal_tax_id)
    {
        if (!is_null($federal_tax_id) && (mb_strlen($federal_tax_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $federal_tax_id when calling Address., must be smaller than or equal to 50.');
        }
    ...
    public function setStateTaxId($state_tax_id)
    {
        if (!is_null($state_tax_id) && (mb_strlen($state_tax_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $state_tax_id when calling Address., must be smaller than or equal to 50.');
        }
    ...
    public function setPersonName($person_name)
    {
        if (!is_null($person_name) && (mb_strlen($person_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $person_name when calling Address., must be smaller than or equal to 50.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling Address., must be smaller than or equal to 50.');
        }
    ...
    public function setStateCode($state_code)
    {
        if (!is_null($state_code) && (mb_strlen($state_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $state_code when calling Address., must be smaller than or equal to 20.');
        }
    ...
    public function setSuburb($suburb)
    {
        if (!is_null($suburb) && (mb_strlen($suburb) > 20)) {
            throw new \InvalidArgumentException('invalid length for $suburb when calling Address., must be smaller than or equal to 20.');
        }
    ...
    public function setAddressLine1($address_line1)
    {
        if (!is_null($address_line1) && (mb_strlen($address_line1) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling Address., must be smaller than or equal to 100.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        if (!is_null($address_line2) && (mb_strlen($address_line2) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling Address., must be smaller than or equal to 100.');
        }
    ...
    public function setObjectType($object_type)
    {
        ...
        if (!is_null($object_type) && (mb_strlen($object_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_type when calling Address., must be bigger than or equal to 1.');
        }
     ...
     * Gets validation
     *
     * @return \Karrio\Model\AddressValidation|null
     */
     ...
     * Sets validation
     *
     * @param \Karrio\Model\AddressValidation|null $validation validation
     *
     * @return self
     */
