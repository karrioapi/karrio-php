...
class AddressData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'validate_location' => 'setValidateLocation'
    ];
    ...
    protected static $getters = [
        ...
        'validate_location' => 'getValidateLocation'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['residential'] = $data['residential'] ?? false;
        $this->container['address_line1'] = $data['address_line1'] ?? null;
        $this->container['address_line2'] = $data['address_line2'] ?? null;
        $this->container['validate_location'] = $data['validate_location'] ?? false;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['federal_tax_id']) && (mb_strlen($this->container['federal_tax_id']) > 50)) {
            $invalidProperties[] = "invalid value for 'federal_tax_id', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['state_tax_id']) && (mb_strlen($this->container['state_tax_id']) > 50)) {
            $invalidProperties[] = "invalid value for 'state_tax_id', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['person_name']) && (mb_strlen($this->container['person_name']) > 50)) {
            $invalidProperties[] = "invalid value for 'person_name', the character length must be smaller than or equal to 50.";
        }
        ...
        if (!is_null($this->container['state_code']) && (mb_strlen($this->container['state_code']) > 20)) {
            $invalidProperties[] = "invalid value for 'state_code', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['suburb']) && (mb_strlen($this->container['suburb']) > 20)) {
            $invalidProperties[] = "invalid value for 'suburb', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['address_line1']) && (mb_strlen($this->container['address_line1']) > 100)) {
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The address postal code  **(required for shipment purchase)**
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling AddressData., must be smaller than or equal to 10.');
        }
     ...
     * Sets city
     *
     * @param string|null $city The address city.  **(required for shipment purchase)**
     *
     * @return self
     */
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AddressData., must be smaller than or equal to 50.');
        }
     ...
     * Sets federal_tax_id
     *
     * @param string|null $federal_tax_id The party frederal tax id
     *
     * @return self
     */
    public function setFederalTaxId($federal_tax_id)
    {
        if (!is_null($federal_tax_id) && (mb_strlen($federal_tax_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $federal_tax_id when calling AddressData., must be smaller than or equal to 50.');
        }
     ...
     * Sets state_tax_id
     *
     * @param string|null $state_tax_id The party state id
     *
     * @return self
     */
    public function setStateTaxId($state_tax_id)
    {
        if (!is_null($state_tax_id) && (mb_strlen($state_tax_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $state_tax_id when calling AddressData., must be smaller than or equal to 50.');
        }
     ...
     * Sets person_name
     *
     * @param string|null $person_name attention to  **(required for shipment purchase)**
     *
     * @return self
     */
    public function setPersonName($person_name)
    {
        if (!is_null($person_name) && (mb_strlen($person_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $person_name when calling AddressData., must be smaller than or equal to 50.');
        }
     ...
     * Sets company_name
     *
     * @param string|null $company_name The company name if the party is a company
     *
     * @return self
     */
    public function setCompanyName($company_name)
    {
        if (!is_null($company_name) && (mb_strlen($company_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling AddressData., must be smaller than or equal to 50.');
        }
     ...
     * Sets email
     *
     * @param string|null $email The party email
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The party phone number.
     *
     * @return self
     */
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling AddressData., must be smaller than or equal to 50.');
        }
     ...
     * Sets state_code
     *
     * @param string|null $state_code The address state code
     *
     * @return self
     */
    public function setStateCode($state_code)
    {
        if (!is_null($state_code) && (mb_strlen($state_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $state_code when calling AddressData., must be smaller than or equal to 20.');
        }
     ...
     * Sets suburb
     *
     * @param string|null $suburb The address suburb if known
     *
     * @return self
     */
    public function setSuburb($suburb)
    {
        if (!is_null($suburb) && (mb_strlen($suburb) > 20)) {
            throw new \InvalidArgumentException('invalid length for $suburb when calling AddressData., must be smaller than or equal to 20.');
        }
     ...
     * Sets residential
     *
     * @param bool|null $residential Indicate if the address is residential or commercial (enterprise)
     *
     * @return self
     */
     ...
     * Sets address_line1
     *
     * @param string|null $address_line1 The address line with street number <br/> **(required for shipment purchase)**
     *
     * @return self
     */
    public function setAddressLine1($address_line1)
    {
        if (!is_null($address_line1) && (mb_strlen($address_line1) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling AddressData., must be smaller than or equal to 100.');
        }
     ...
     * Sets address_line2
     *
     * @param string|null $address_line2 The address line with suite number
     *
     * @return self
     */
    public function setAddressLine2($address_line2)
    {
        if (!is_null($address_line2) && (mb_strlen($address_line2) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling AddressData., must be smaller than or equal to 100.');
        }
    ...
    /**
     * Gets validate_location
     *
     * @return bool|null
     */
    public function getValidateLocation()
    {
        return $this->container['validate_location'];
    }

    /**
     * Sets validate_location
     *
     * @param bool|null $validate_location Indicate if the address should be validated
     *
     * @return self
     */
    public function setValidateLocation($validate_location)
    {
        $this->container['validate_location'] = $validate_location;
