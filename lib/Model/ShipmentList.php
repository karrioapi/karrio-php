...
class ShipmentList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'next' => 'string',
        'previous' => 'string',
        'results' => '\Purplship\Model\Shipment[]'
    ];
    ...
    public function setNext($next)
    {
        ...
        if (!is_null($next) && (mb_strlen($next) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next when calling ShipmentList., must be bigger than or equal to 1.');
        }
    ...
    public function setPrevious($previous)
    {
        ...
        if (!is_null($previous) && (mb_strlen($previous) < 1)) {
            throw new \InvalidArgumentException('invalid length for $previous when calling ShipmentList., must be bigger than or equal to 1.');
        }
     ...
     * Sets results
     *
     * @param \Purplship\Model\Shipment[] $results results
     *
     * @return self
     */
