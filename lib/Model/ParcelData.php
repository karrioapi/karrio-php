...
class ParcelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\Karrio\Model\CommodityData[]',
    ...
    public function setPackagingType($packaging_type)
    {
        if (!is_null($packaging_type) && (mb_strlen($packaging_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $packaging_type when calling ParcelData., must be smaller than or equal to 50.');
        }
    ...
    public function setPackagePreset($package_preset)
    {
        if (!is_null($package_preset) && (mb_strlen($package_preset) > 50)) {
            throw new \InvalidArgumentException('invalid length for $package_preset when calling ParcelData., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 250)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ParcelData., must be smaller than or equal to 250.');
        }
    ...
    public function setContent($content)
    {
        if (!is_null($content) && (mb_strlen($content) > 100)) {
            throw new \InvalidArgumentException('invalid length for $content when calling ParcelData., must be smaller than or equal to 100.');
        }
     ...
     * Gets items
     *
     * @return \Karrio\Model\CommodityData[]|null
     */
     ...
     * Sets items
     *
     * @param \Karrio\Model\CommodityData[]|null $items The parcel items.
     *
     * @return self
     */
    ...
    public function setReferenceNumber($reference_number)
    {
        if (!is_null($reference_number) && (mb_strlen($reference_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $reference_number when calling ParcelData., must be smaller than or equal to 100.');
        }
        if (!is_null($reference_number) && (mb_strlen($reference_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference_number when calling ParcelData., must be bigger than or equal to 1.');
        }
