...
class Pickup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'pickup_date' => 'string',
        'pickup_charge' => '\Karrio\Model\Charge',
        'ready_time' => 'string',
        'closing_time' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object_type'] = $data['object_type'] ?? 'pickup';
    ...
    public function setObjectType($object_type)
    {
        ...
        if (!is_null($object_type) && (mb_strlen($object_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_type when calling Pickup., must be bigger than or equal to 1.');
        }
     ...
     * Sets pickup_charge
     *
     * @param \Karrio\Model\Charge|null $pickup_charge pickup_charge
     *
     * @return self
     */
