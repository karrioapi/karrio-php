...
/**
 * PickupUpdateData Class Doc Comment
 *
 * @category Class
 * @package  Purplship
 * @author   OpenAPI Generator team
 ...
 */
class PickupUpdateData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PickupUpdateData';
     ...
     * Sets pickup_date
     *
     * @param string|null $pickup_date The expected pickup date  Date Format: YYYY-MM-DD
     *
     * @return self
     */
    public function setPickupDate($pickup_date)
    {
        ...
        if (!is_null($pickup_date) && (mb_strlen($pickup_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pickup_date when calling PickupUpdateData., must be bigger than or equal to 1.');
        }
     ...
     * Sets ready_time
     *
     * @param string|null $ready_time The ready time for pickup.
     *
     * @return self
     */
     ...
     * Sets closing_time
     *
     * @param string|null $closing_time The closing or late time of the pickup
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $tracking_numbers The list of shipments to be picked up
     *
     * @return self
     */
    ...
    public function setConfirmationNumber($confirmation_number)
    {
        ...
        if ((mb_strlen($confirmation_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $confirmation_number when calling PickupUpdateData., must be bigger than or equal to 1.');
        }
