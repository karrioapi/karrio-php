...
/**
 * PickupCancelData Class Doc Comment
 *
 * @category Class
 * @package  Purplship
 * @author   OpenAPI Generator team
 ...
 */
class PickupCancelData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PickupCancelData';
    ...
    public function setReason($reason)
    {
        ...
        if (!is_null($reason) && (mb_strlen($reason) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling PickupCancelData., must be bigger than or equal to 1.');
        }
