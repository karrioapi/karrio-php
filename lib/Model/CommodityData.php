...
class CommodityData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 250)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CommodityData., must be smaller than or equal to 250.');
        }
    ...
    public function setSku($sku)
    {
        if (!is_null($sku) && (mb_strlen($sku) > 100)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling CommodityData., must be smaller than or equal to 100.');
        }
    ...
    public function setValueCurrency($value_currency)
    {
        if (!is_null($value_currency) && (mb_strlen($value_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $value_currency when calling CommodityData., must be smaller than or equal to 3.');
        }
    ...
    public function setOriginCountry($origin_country)
    {
        if (!is_null($origin_country) && (mb_strlen($origin_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $origin_country when calling CommodityData., must be smaller than or equal to 3.');
        }
    ...
    public function setParentId($parent_id)
    {
        ...
        if (!is_null($parent_id) && (mb_strlen($parent_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parent_id when calling CommodityData., must be bigger than or equal to 1.');
        }
