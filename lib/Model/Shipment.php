...
class Shipment implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['selected_rate_id']) && (mb_strlen($this->container['selected_rate_id']) < 1)) {
    ...
    public function setCarrierName($carrier_name)
    {
        ...
        if (!is_null($carrier_name) && (mb_strlen($carrier_name) < 1)) {
    ...
    public function setCarrierId($carrier_id)
    {
        ...
        if (!is_null($carrier_id) && (mb_strlen($carrier_id) < 1)) {
    ...
    public function setSelectedRateId($selected_rate_id)
    {
        ...
        if (!is_null($selected_rate_id) && (mb_strlen($selected_rate_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $selected_rate_id when calling Shipment., must be bigger than or equal to 1.');
        }
