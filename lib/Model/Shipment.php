...
class Shipment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setObjectType($object_type)
    {
        ...
        if (!is_null($object_type) && (mb_strlen($object_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_type when calling Shipment., must be bigger than or equal to 1.');
        }
     ...
     * Sets label_url
     *
     * @param string|null $label_url The shipment label URL
     *
     * @return self
     */
     ...
     * Sets invoice_url
     *
     * @param string|null $invoice_url The shipment invoice URL
     *
     * @return self
     */
