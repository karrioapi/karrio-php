...
class RateRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets services
     *
     * @param string[] $services The requested carrier service for the shipment.<br/> Please consult the reference for specific carriers services.  Note that this is a list because on a Multi-carrier rate request you could specify a service per carrier.
     *
     * @return $this
     */
     ...
     * Sets options
     *
     * @param map[string,string] $options The options available for the shipment.  Please consult the reference for additional specific carriers options.
     *
     * @return $this
     */
