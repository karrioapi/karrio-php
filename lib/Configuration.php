...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://instance.purplship.api/v1';

    /**
     * User agent of the HTTP request, set to "PHP-PurplShip" by default
     *
     * @var string
     */
    protected $userAgent = 'PurplShip-Codegen/1.0.0/php';
    ...
    {
        $report  = 'PHP SDK (PurplShip) Debug Report:' . PHP_EOL;
