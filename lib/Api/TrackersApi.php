...
class TrackersApi
{
     ...
     * @return \Purplship\Model\TrackerList
     */
     ...
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Purplship\Model\TrackerList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    protected function retrieveRequest($carrier_name, $tracking_number, $test = 'false')
    {
        ...
        $resourcePath = '/trackers/{carrier_name}/{tracking_number}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
