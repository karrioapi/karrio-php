...
class TrackersApi
{
     ...
     * @return \Karrio\Model\TrackingStatus|\Karrio\Model\ErrorResponse
     */
    public function create($tracking_number, $carrier_name, $test = false)
    {
        list($response) = $this->createWithHttpInfo($tracking_number, $carrier_name, $test);
        return $response;
    }
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\TrackingStatus|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($tracking_number, $carrier_name, $test = false)
    {
        $request = $this->createRequest($tracking_number, $carrier_name, $test);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\TrackingStatus' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\TrackingStatus', []),
            ...
            $returnType = '\Karrio\Model\TrackingStatus';
     ...
     */
    public function createAsync($tracking_number, $carrier_name, $test = false)
    {
        return $this->createAsyncWithHttpInfo($tracking_number, $carrier_name, $test)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($tracking_number, $carrier_name, $test = false)
    {
        $returnType = '\Karrio\Model\TrackingStatus';
        $request = $this->createRequest($tracking_number, $carrier_name, $test);
     ...
     */
    public function createRequest($tracking_number, $carrier_name, $test = false)
    {
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\TrackerList|\Karrio\Model\ErrorResponse
     */
    public function list($test_mode = null, $status = null, $created_after = null, $created_before = null, $carrier_id = null, $limit = null, $offset = null, $carrier_name = null)
    {
        list($response) = $this->listWithHttpInfo($test_mode, $status, $created_after, $created_before, $carrier_id, $limit, $offset, $carrier_name);
        return $response;
    }
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\TrackerList|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listWithHttpInfo($test_mode = null, $status = null, $created_after = null, $created_before = null, $carrier_id = null, $limit = null, $offset = null, $carrier_name = null)
    {
        $request = $this->listRequest($test_mode, $status, $created_after, $created_before, $carrier_id, $limit, $offset, $carrier_name);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\TrackerList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\TrackerList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Karrio\Model\TrackerList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAsync($test_mode = null, $status = null, $created_after = null, $created_before = null, $carrier_id = null, $limit = null, $offset = null, $carrier_name = null)
    {
        return $this->listAsyncWithHttpInfo($test_mode, $status, $created_after, $created_before, $carrier_id, $limit, $offset, $carrier_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAsyncWithHttpInfo($test_mode = null, $status = null, $created_after = null, $created_before = null, $carrier_id = null, $limit = null, $offset = null, $carrier_name = null)
    {
        $returnType = '\Karrio\Model\TrackerList';
        $request = $this->listRequest($test_mode, $status, $created_after, $created_before, $carrier_id, $limit, $offset, $carrier_name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listRequest($test_mode = null, $status = null, $created_after = null, $created_before = null, $carrier_id = null, $limit = null, $offset = null, $carrier_name = null)
    {
