...
class PickupsApi
{
     ...
     */
    public function cancel($body, $id)
    {
        list($response) = $this->cancelWithHttpInfo(is_array($body) ? new \Purplship\Model\PickupCancelData($body) : $body, $carrier_name, $test);
        return $response;
    }
     ...
     */
    public function cancelWithHttpInfo($body, $id)
    {
        $returnType = '\Purplship\Model\OperationConfirmation';
        $request = $this->cancelRequest($body, $id);
     ...
     */
    public function cancelAsync($body, $id)
    {
        return $this->cancelAsyncWithHttpInfo($body, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelAsyncWithHttpInfo($body, $id)
    {
        $returnType = '\Purplship\Model\OperationConfirmation';
        $request = $this->cancelRequest($body, $id);
     ...
     */
    protected function cancelRequest($body, $id)
    {
        ...
        $resourcePath = '/pickups/{id}/cancel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Purplship\Model\PickupList
     */
     ...
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Purplship\Model\PickupList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    protected function scheduleRequest($body, $carrier_name, $test = 'false')
    {
        ...
        $resourcePath = '/pickups/{carrier_name}/schedule';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->updateWithHttpInfo(is_array($body) ? new \Purplship\Model\PickupUpdateData($body) : $body, $id);
        return $response;
    }
