...
class PickupsApi
{
     ...
     * Cancel a pickup
     *
     * @param  \Karrio\Model\PickupCancelData $data data (required)
     * @param  string $id id (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\OperationConfirmation|\Karrio\Model\ErrorResponse
     */
     ...
     * Cancel a pickup
     *
     * @param  \Karrio\Model\PickupCancelData $data (required)
     * @param  string $id (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\OperationConfirmation|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelWithHttpInfo($data, $id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\OperationConfirmation' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\OperationConfirmation', []),
            ...
            $returnType = '\Karrio\Model\OperationConfirmation';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Karrio\Model\OperationConfirmation',
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\PickupList|\Karrio\Model\ErrorResponse
     */
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\PickupList|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listWithHttpInfo($test_mode = null, $limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\PickupList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\PickupList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Karrio\Model\PickupList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\Pickup|\Karrio\Model\ErrorResponse
     */
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\Pickup|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\Pickup' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\Pickup', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Karrio\Model\Pickup';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * Schedule a pickup
     *
     * @param  \Karrio\Model\PickupData $data data (required)
     ...
     * Schedule a pickup
     *
     * @param  \Karrio\Model\PickupData $data (required)
     ...
     * Update a pickup
     *
     * @param  \Karrio\Model\PickupUpdateData $data data (required)
     * @param  string $id id (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Update a pickup
     *
     * @param  \Karrio\Model\PickupUpdateData $data (required)
     * @param  string $id (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
