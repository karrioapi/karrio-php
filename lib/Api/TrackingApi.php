...
class TrackingApi
{
     ...
     */
    public function retrieve($carrier_name, $tracking_number, $test = 'false')
    {
        list($response) = $this->retrieveWithHttpInfo($carrier_name, $tracking_number, $test);
        return $response;
    }
     ...
     */
    public function retrieveWithHttpInfo($carrier_name, $tracking_number, $test = 'false')
    {
        $returnType = '\Purplship\Model\TrackingStatus';
        $request = $this->retrieveRequest($carrier_name, $tracking_number, $test);
     ...
     */
    public function retrieveAsync($carrier_name, $tracking_number, $test = 'false')
    {
        return $this->retrieveAsyncWithHttpInfo($carrier_name, $tracking_number, $test)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAsyncWithHttpInfo($carrier_name, $tracking_number, $test = 'false')
    {
        $returnType = '\Purplship\Model\TrackingStatus';
        $request = $this->retrieveRequest($carrier_name, $tracking_number, $test);
     ...
     */
    protected function retrieveRequest($carrier_name, $tracking_number, $test = 'false')
    {
        // verify the required parameter 'carrier_name' is set
        if ($carrier_name === null || (is_array($carrier_name) && count($carrier_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $carrier_name when calling retrieve'
            );
        }
        ...
        if ($tracking_number === null || (is_array($tracking_number) && count($tracking_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tracking_number when calling retrieve'
            );
        }
     ...
     * @return \Purplship\Model\TrackingStatus[]
     */
    public function statuses($limit = null, $offset = null)
    {
        list($response) = $this->statusesWithHttpInfo($limit, $offset);
        return $response;
    }
     ...
     * @return array of \Purplship\Model\TrackingStatus[], HTTP status code, HTTP response headers (array of strings)
     */
    public function statusesWithHttpInfo($limit = null, $offset = null)
    {
        $returnType = '\Purplship\Model\TrackingStatus[]';
        $request = $this->statusesRequest($limit, $offset);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function statusesAsync($limit = null, $offset = null)
    {
        return $this->statusesAsyncWithHttpInfo($limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation statusesAsyncWithHttpInfo
     *
     * List all tracking statuses
     *
     * @param  int $limit Number of results to return per page. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function statusesAsyncWithHttpInfo($limit = null, $offset = null)
    {
        $returnType = '\Purplship\Model\TrackingStatus[]';
        $request = $this->statusesRequest($limit, $offset);
    ...
    /**
     * Create request for operation 'statuses'
     *
     * @param  int $limit Number of results to return per page. (optional)
     * @param  int $offset The initial index from which to return the results. (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function statusesRequest($limit = null, $offset = null)
    {
