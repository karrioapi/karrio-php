...
class WebhooksApi
{
     ...
     * Create a webhook
     *
     * @param  \Karrio\Model\WebhookData $data data (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\Webhook|\Karrio\Model\ErrorResponse
     */
     ...
     * Create a webhook
     *
     * @param  \Karrio\Model\WebhookData $data (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\Webhook|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($data)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\Webhook' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\Webhook', []),
            ...
            $returnType = '\Karrio\Model\Webhook';
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\WebhookList|\Karrio\Model\ErrorResponse
     */
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\WebhookList|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listWithHttpInfo($limit = null, $offset = null, $test_mode = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\WebhookList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\WebhookList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Karrio\Model\WebhookList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * Test a webhook
     *
     * @param  \Karrio\Model\WebhookTestRequest $data data (required)
     * @param  string $id id (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Test a webhook
     *
     * @param  \Karrio\Model\WebhookTestRequest $data (required)
     * @param  string $id (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
