...
class ProxyApi
{
    ...
    {
        list($response) = $this->fetchWithHttpInfo(is_array($body) ? new \Purplship\Model\RateRequest($body) : $body);
        return $response;
    }
     ...
     */
    public function fetchWithHttpInfo($body)
    {
        $returnType = '\Purplship\Model\RateResponse';
        $request = $this->fetchRequest($body);
    ...
    {
        return $this->fetchAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchAsyncWithHttpInfo($body)
    {
        $returnType = '\Purplship\Model\RateResponse';
        $request = $this->fetchRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function fetchRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling fetch'
            );
        }
