...
class ProxyApi
{
    ...
    public function buyLabel($data)
    {
        list($response) = $this->buyLabelWithHttpInfo(
            is_array($data) ? new \Purplship\Model\ShippingRequest($data) : $data);
        return $response;
    }
     ...
     */
    public function cancelPickup($carrier_name, $data, $test = false)
    {
        list($response) = $this->cancelPickupWithHttpInfo(
            $carrier_name, is_array($data) ? new \Purplship\Model\PickupCancelRequest($data) : $data, $test);
        return $response;
    }
     ...
     */
    public function cancelPickupWithHttpInfo($carrier_name, $data, $test = false)
    {
        $request = $this->cancelPickupRequest($carrier_name, $data, $test);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelPickupAsync($carrier_name, $data, $test = false)
    {
        return $this->cancelPickupAsyncWithHttpInfo($carrier_name, $data, $test)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelPickupAsyncWithHttpInfo($carrier_name, $data, $test = false)
    {
        $returnType = '\Purplship\Model\OperationResponse';
        $request = $this->cancelPickupRequest($carrier_name, $data, $test);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cancelPickupRequest($carrier_name, $data, $test = false)
    {
     ...
     */
    public function fetchRates($data)
    {
        list($response) = $this->fetchRatesWithHttpInfo(
            is_array($data) ? new \Purplship\Model\RateRequest($data) : $data);
        return $response;
    }
     ...
     */
    public function fetchRatesWithHttpInfo($data)
    {
        $request = $this->fetchRatesRequest($data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchRatesAsync($data)
    {
        return $this->fetchRatesAsyncWithHttpInfo($data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchRatesAsyncWithHttpInfo($data)
    {
        $returnType = '\Purplship\Model\RateResponse';
        $request = $this->fetchRatesRequest($data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function fetchRatesRequest($data)
    {
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function schedulePickup($carrier_name, $data, $test = false)
    {
        list($response) = $this->schedulePickupWithHttpInfo(
            $carrier_name, is_array($data) ? new \Purplship\Model\PickupRequest($data) : $data, $test);
        return $response;
    }
     ...
     */
    public function schedulePickupWithHttpInfo($carrier_name, $data, $test = false)
    {
        $request = $this->schedulePickupRequest($carrier_name, $data, $test);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function schedulePickupAsync($carrier_name, $data, $test = false)
    {
        return $this->schedulePickupAsyncWithHttpInfo($carrier_name, $data, $test)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function schedulePickupAsyncWithHttpInfo($carrier_name, $data, $test = false)
    {
        $returnType = '\Purplship\Model\PickupResponse';
        $request = $this->schedulePickupRequest($carrier_name, $data, $test);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function schedulePickupRequest($carrier_name, $data, $test = false)
    {
        // verify the required parameter 'carrier_name' is set
        if ($carrier_name === null || (is_array($carrier_name) && count($carrier_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackShipmentRequest($carrier_name, $tracking_number, $test = false)
    {
        // verify the required parameter 'carrier_name' is set
        if ($carrier_name === null || (is_array($carrier_name) && count($carrier_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Purplship\Model\PickupResponse|\Purplship\Model\ErrorResponse
     */
    public function updatePickup($carrier_name, $data, $test = false)
    {
        list($response) = $this->updatePickupWithHttpInfo(
            $carrier_name, is_array($data) ? new \Purplship\Model\PickupUpdateRequest($data) : $data, $test);
        return $response;
    }
     ...
     * @return array of \Purplship\Model\PickupResponse|\Purplship\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePickupWithHttpInfo($carrier_name, $data, $test = false)
    {
        $request = $this->updatePickupRequest($carrier_name, $data, $test);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePickupAsync($carrier_name, $data, $test = false)
    {
        return $this->updatePickupAsyncWithHttpInfo($carrier_name, $data, $test)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePickupAsyncWithHttpInfo($carrier_name, $data, $test = false)
    {
        $returnType = '\Purplship\Model\PickupResponse';
        $request = $this->updatePickupRequest($carrier_name, $data, $test);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePickupRequest($carrier_name, $data, $test = false)
    {
        // verify the required parameter 'carrier_name' is set
        if ($carrier_name === null || (is_array($carrier_name) && count($carrier_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Purplship\Model\OperationResponse|\Purplship\Model\ErrorResponse
     */
    public function voidLabel($carrier_name, $data, $test = false)
    {
        list($response) = $this->voidLabelWithHttpInfo($carrier_name, $data, $test);
        return $response;
    }
     ...
     * @return array of \Purplship\Model\OperationResponse|\Purplship\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function voidLabelWithHttpInfo($carrier_name, $data, $test = false)
    {
        $request = $this->voidLabelRequest($carrier_name, $data, $test);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voidLabelAsync($carrier_name, $data, $test = false)
    {
        return $this->voidLabelAsyncWithHttpInfo($carrier_name, $data, $test)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function voidLabelAsyncWithHttpInfo($carrier_name, $data, $test = false)
    {
        $returnType = '\Purplship\Model\OperationResponse';
        $request = $this->voidLabelRequest($carrier_name, $data, $test);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function voidLabelRequest($carrier_name, $data, $test = false)
    {
        // verify the required parameter 'carrier_name' is set
        if ($carrier_name === null || (is_array($carrier_name) && count($carrier_name) === 0)) {
            throw new \InvalidArgumentException(
