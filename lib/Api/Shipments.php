...
class Shipments
{
     ...
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Purplship\Model\Tracking
     */
     ...
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Purplship\Model\Tracking, HTTP status code, HTTP response headers (array of strings)
     */
    public function trackWithHttpInfo($carrier_id, $tracking_number)
    {
        $returnType = '\Purplship\Model\Tracking';
