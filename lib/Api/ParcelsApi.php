...
class ParcelsApi
{
     ...
     * Create a parcel
     *
     * @param  \Karrio\Model\ParcelData $data data (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\Parcel|\Karrio\Model\ErrorResponse
     */
     ...
     * Create a parcel
     *
     * @param  \Karrio\Model\ParcelData $data (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\Parcel|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($data)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\Parcel' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\Parcel', []),
            ...
            $returnType = '\Karrio\Model\Parcel';
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\ParcelList|\Karrio\Model\ErrorResponse
     */
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\ParcelList|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listWithHttpInfo($limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\ParcelList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\ParcelList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Karrio\Model\ParcelList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
