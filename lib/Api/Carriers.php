...
class Carriers
{
     ...
     * @param  string $carrier_id Indicates a specific carrier configuration name. (optional)
     * @param  bool $test The test flag indicates whether to use a carrier configured for test. (optional)
     *
     * @throws \PurplShip\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PurplShip\Model\CarrierSettings[]
     */
    public function retrieve($carrier_name = null, $carrier_id = null, $test = null)
    {
        list($response) = $this->retrieveWithHttpInfo($carrier_name, $carrier_id, $test);
        return $response;
    }
     ...
     */
    public function retrieveWithHttpInfo($carrier_name = null, $carrier_id = null, $test = null)
    {
        $returnType = '\PurplShip\Model\CarrierSettings[]';
        $request = $this->retrieveRequest($carrier_name, $carrier_id, $test);
     ...
     */
    public function retrieveAsync($carrier_name = null, $carrier_id = null, $test = null)
    {
        return $this->retrieveAsyncWithHttpInfo($carrier_name, $carrier_id, $test)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAsyncWithHttpInfo($carrier_name = null, $carrier_id = null, $test = null)
    {
        $returnType = '\PurplShip\Model\CarrierSettings[]';
        $request = $this->retrieveRequest($carrier_name, $carrier_id, $test);
     ...
     */
    protected function retrieveRequest($carrier_name = null, $carrier_id = null, $test = null)
    {
        if ($carrier_id !== null && strlen($carrier_id) < 1) {
            throw new \InvalidArgumentException('invalid length for "$carrier_id" when calling Carriers.retrieve, must be bigger than or equal to 1.');
        }
