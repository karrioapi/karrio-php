...
class Carriers
{
    ...
    {
        list($response) = $this->listWithHttpInfo($carrier_name, $test);
        return $response;
    }
     ...
     */
    public function listAsync($carrier_name = null, $test = null)
    {
        return $this->listAsyncWithHttpInfo($carrier_name, $test)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function listRequest($carrier_name = null, $test = null)
    {
        ...
        if ($carrier_name !== null) {
            $queryParams['carrier_name'] = ObjectSerializer::toQueryValue($carrier_name);
        }
        // query params
        if ($test !== null) {
        ...
        if ($this->config->getAccessToken() !== null) {
            $headers['Authorization'] = 'Token ' . $this->config->getAccessToken();
        }
    ...
    {
        list($response) = $this->retrieveWithHttpInfo($carrier_id_or_pk);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAsync($carrier_id_or_pk)
    {
        return $this->retrieveAsyncWithHttpInfo($carrier_id_or_pk)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveRequest($carrier_id_or_pk)
    {
        // verify the required parameter 'carrier_id_or_pk' is set
        if ($carrier_id_or_pk === null || (is_array($carrier_id_or_pk) && count($carrier_id_or_pk) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $carrier_id_or_pk when calling retrieve'
            );
        }

        $resourcePath = '/carriers/{carrier_id_or_pk}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($carrier_id_or_pk !== null) {
            $resourcePath = str_replace(
                '{' . 'carrier_id_or_pk' . '}',
                ObjectSerializer::toPathValue($carrier_id_or_pk),
                $resourcePath
            );
        }
