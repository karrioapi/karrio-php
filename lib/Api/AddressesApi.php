...
class AddressesApi
{
     ...
     * Create an address
     *
     * @param  \Karrio\Model\AddressData $data data (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\Address|\Karrio\Model\ErrorResponse
     */
     ...
     * Create an address
     *
     * @param  \Karrio\Model\AddressData $data (required)
     *
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\Address|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($data)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\Address' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\Address', []),
            ...
            $returnType = '\Karrio\Model\Address';
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Karrio\Model\AddressList|\Karrio\Model\ErrorResponse
     */
     ...
     * @throws \Karrio\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Karrio\Model\AddressList|\Karrio\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listWithHttpInfo($limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Karrio\Model\AddressList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Karrio\Model\AddressList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Karrio\Model\AddressList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
