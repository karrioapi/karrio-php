...
class AddressesApi
{
     ...
     * Create an address
     *
     * @param  \Purplship\Model\AddressData $data data (required)
     *
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Purplship\Model\Address|\Purplship\Model\ErrorResponse
     */
     ...
     * Create an address
     *
     * @param  \Purplship\Model\AddressData $data (required)
     *
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Purplship\Model\Address|\Purplship\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($data)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Purplship\Model\Address' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Purplship\Model\Address', []),
            ...
            $returnType = '\Purplship\Model\Address';
     ...
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Purplship\Model\AddressList|\Purplship\Model\ErrorResponse
     */
     ...
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Purplship\Model\AddressList|\Purplship\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listWithHttpInfo($limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Purplship\Model\AddressList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Purplship\Model\AddressList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Purplship\Model\AddressList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
