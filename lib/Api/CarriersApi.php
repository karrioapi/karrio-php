...
class CarriersApi
{
     ...
     * @return \Purplship\Model\CarrierList
     */
     ...
     * @throws \Purplship\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Purplship\Model\CarrierList, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    protected function listRequest($limit = null, $offset = null, $carrier_name = null, $test = null, $active = null, $system_only = 'false')
    {
        ...
        // query params
        if ($system_only !== null) {
            $queryParams['system_only'] = ObjectSerializer::toQueryValue($system_only, null);
        }
