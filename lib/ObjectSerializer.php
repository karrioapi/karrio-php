...
class ObjectSerializer
{
     ...
     * @param string $type   the PurplShipType of the data
     * @param string $format the format of the PurplShip type of the data
     *
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\PurplShip\Model\\' . $data->{$discriminator};
